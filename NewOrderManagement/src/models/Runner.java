...
public class Runner {
	...
	public static void main(String[] args) {
		...
		products[0] = new Product("Dress", "M", "Blue", 200, 2);
		products[1] = new Product("Blouse", "S", "Red", 200, 3);
		products[2] = new Product("Socks", "L", "Pink", 200, 5);
		products[3] = new Product("Trousers", "M", "Green", 200, 4);
		products[4] = new Product("Hat", "M", "Orange", 200, 1);
